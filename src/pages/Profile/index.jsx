...
//     const bonde = fetch(`http://localhost:8000/freelance?id=${id}`)
//          .then((response) => response.json())
...
//     return (
//       <ThemeContext.Consumer>
//         {bonde.map((profile, id) => (
//           <ProfileWrapper theme={theme}>
//             <Picture src={profile.picture} alt={profile.name} height={150} width={150} />
//             <ProfileDetails theme={theme}>
//               <TitleWrapper>
...
//                 {profile.available ? 'Disponible maintenant' : 'Indisponible'}
//               </Availability>
//               <Price>{profile.tjm} € / jour</Price>
//             </ProfileDetails>
//           </ProfileWrapper>
//         ))}
//       </ThemeContext.Consumer>
